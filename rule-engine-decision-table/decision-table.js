...
module.exports = function (RED) {
  function DecisionTableNode(config) {
    ...
    function getObjectWithDotChain(obj, str) {
      if (typeof str === 'string') {return getObjectWithDotChain(obj, str.split('.'));} else if (str.length === 0) {return obj;}
    ...
    function setObjectWithDotChain(obj, str, value) {
      if (typeof str === 'string') {setObjectWithDotChain(obj, str.split('.'), value);} else if (str.length === 1 && value) {obj[str[0]] = value;} else {setObjectWithDotChain(obj[str[0]], str.slice(1), value);}
    }
  }
